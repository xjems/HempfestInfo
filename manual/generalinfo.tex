...
Hempfest Information is one the main public faces of Hempfest org at the event. We have a responsibility to provide timely and accurate information to all festival goers who visit us,along with a smile! The booth is located north of the pumphouse between the paths. 
...
\begin{itemize}
	\item 	 If you find a lost child or a parent who has lost a child, stay with the parent or kid and send someone else to find someone with a radio!  Usually the person that they’re looking for re-appears at this point. If not, when the radio arrives report to Operations the child’s:
\begin{itemize}
	\item Name
\item Age
...
\end{itemize}
\item Wait for further instructions from Operations. The child/parent should stay in the spot where you encountered them for at least fifteen minutes.
...
ALL  vendors must have a PASS. There is no strolling vending! Vendors selling brownies must be immediately reported to Hempfest Safety Staff.  Please report unauthorized vending to security or any staff with a radio. 
...
If someone asks a particularly interesting question or you get a repeated question not on the FAQ list, please let the info booth coordinator know! 
...
Hempfest is a non profit organization and produced by volunteers. Please consider asking all visitors to the information booth to drop a five dollar donation into our bucket. It all goes back into the fest! We need the public's help to continue our message of freedom! 

\section{Voter Registration}
Booth is located South of Hemposium. We also have forms at infobooth. 

\section{Medical MJ Information}
There are many patient and legal groups at Seattle Hempfest. Historically they have been centered near Stone Village. 

\section{Lost and Found}
Fill out lost item form, make sure you can read the contact information. Seperate items into clothing and other items. If cellphone, wallet, or keys, give to coord. 
